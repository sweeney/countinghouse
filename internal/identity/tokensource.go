// Package identity provides the outbound client_credentials TokenSource used
// for service-to-service calls (the remote config fetches). It mirrors
// statehouse's identity.TokenSource.
package identity
